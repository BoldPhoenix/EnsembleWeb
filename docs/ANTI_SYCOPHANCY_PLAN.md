...
- [ ] Layer 1: Anti-sycophancy directives in system prompt composer
- [ ] Layer 2: Provider tier selection + warning in settings
- [ ] Layer 3: Output filter with warn-mode logging (no blocking yet)
...
- [ ] Layer 3: Promote output filter from warn-mode to rewrite-mode
- [ ] Layer 4: Adversarial context retrieval via MemoryStore extension
- [ ] Layer 7: Hard output constraints (post-processor)
...
- [ ] Layer 5: `rewardAntiSycophancy` function added to reward registry
- [ ] Layer 6: Skill auto-creator monitors correction patterns
- [ ] Wire everything into existing APO beam search
...
- [ ] Layer 8: Mental health detector + referral system
- [ ] Comprehensive settings UI: "How [Name] Pushes Back"
- [ ] User-visible sycophancy incident log
